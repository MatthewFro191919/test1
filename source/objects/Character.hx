...
class Character extends FlxSprite
{
	...
	**/
	...
	public function loadCharacterFile(json:Dynamic)
	{
		...
		// 🔹 NEW: check for AnimateAtlas .zip first
		#if MODS_ALLOWED
		var zipPath = Paths.mods('characters/' + curCharacter + '.zip');
		if (FileSystem.exists(zipPath)) {
			frames = AnimateAtlas.loadFromZip(zipPath);
			trace("Loaded AnimateAtlas zip for " + curCharacter);
